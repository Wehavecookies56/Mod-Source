...
import kwx.modID.slot.SlotBreeder;
...
{
private TileEntityBreeder blast;
private int dualCookTime;
private int dualBurnTime;
private int lastItemBurnTime;

public ContainerBreeder(InventoryPlayer inventoryplayer, TileEntityBreeder tileentityBreeder)
{
         dualCookTime = 0;
         dualBurnTime = 0;
         lastItemBurnTime = 0;
         blast = tileentityBreeder;
         this.addSlotToContainer(new Slot(tileentityBreeder, 0, 38, 17));
         this.addSlotToContainer(new Slot(tileentityBreeder, 1, 74, 17));
         this.addSlotToContainer(new Slot(tileentityBreeder, 2, 56, 53));
         this.addSlotToContainer(new SlotBreeder(inventoryplayer.player, tileentityBreeder, 3, 116, 35));
         for (int i = 0; i < 3; i++)
         {
                 for (int k = 0; k < 9; k++)
                 {
