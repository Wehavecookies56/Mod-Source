...
import kwx.modID.recipes.BreederRecipes;
...
private boolean canSmelt()
{
         ...
         ItemStack itemstack = BreederRecipes.getSmeltingResult(blastItemStacks[0].getItem().itemID, blastItemStacks[1].getItem().itemID);
         if (itemstack == null)
         {
                 return false;
         }
...
private int getItemBurnTime(ItemStack itemstack)
{
    ...
    else
    {
            ...
            if (i == AddedItems.MullberryLeaves.itemID) return 200;
