package kwx.tek.block.rubberTree;
...
public class blockRubberSapling extends BlockFlower
{
    public static final String[] WOOD_TYPES = new String[] {"rubber"};
    @SideOnly(Side.CLIENT)
    private Icon[] saplingIcon;

    public blockRubberSapling(int par1)
    {
        super(par1);
        float f = 0.4F;
    ...
    public void growTree(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        else if (l == 3)
        {
            ...
            if (object == null)
            {
                j1 = 0;
                i1 = 0;
                object = new RubberWorldGenTrees(true, 4 + par5Random.nextInt(7), 3, 3, false);
            }
        }
        else
        {
            object = new RubberWorldGenTrees(true);
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.saplingIcon[i] = par1IconRegister.registerIcon(Reference.MOD_ID + ":" + "rubberSapling");
        }
    }
}
