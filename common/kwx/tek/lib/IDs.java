...
public class IDs {
	...
	public static int aluminiumOre;
	public static int siliconOre;
	public static int uraniumOre;
	...
	public static final int ALUMINIUMORE_DEFAULT = 1502;
	public static final int SILICONORE_DEFUALT = 1503;
