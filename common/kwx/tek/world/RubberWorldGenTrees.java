...
public class RubberWorldGenTrees extends WorldGenerator
{
    ...
    public RubberWorldGenTrees(boolean par1)
    {
        this(par1, 4, 0, 0, false);
    }

    public RubberWorldGenTrees(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
            ...
            else
            {
                ...
                if (isSoil && par4 < 256 - l - 1)
                {
                        ...
                        for (j2 = par3 - i2; j2 <= par3 + i2; ++j2)
                        {
                            ...
                            for (int l2 = par5 - i2; l2 <= par5 + i2; ++l2)
                            {
                                ...
                                if (Math.abs(k2) != i2 || Math.abs(i3) != i2 || par2Random.nextInt(2) != 0 && k1 != 0)
                                {
                                    ...
                                    {
                                        this.setBlockAndMetadata(par1World, j2, j1, l2, AddedBlocks.rubberLeaves.blockID, this.metaLeaves);
                                    }
                                }
                            }
                        }
                    ...
                    for (j1 = 0; j1 < l; ++j1)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + j1, par5, AddedBlocks.rubberLog.blockID, this.metaWood);
